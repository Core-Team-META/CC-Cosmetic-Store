--[[
	...
	* The template should contain a series of folders, which will be attached to the corresponding
	...
	Set the following variables bellow the while loop to nil: 
	...
	Finally, ensure that AllowSubscriptionPurchase custom property in the STORE_CosmeticStore folder is set
	to false.]
