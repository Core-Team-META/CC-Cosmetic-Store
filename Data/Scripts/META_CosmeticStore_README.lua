--[[
	...
	* The template should contain a series of folders, which will be attached to the corresponding
	...
	Also, the following custom properties in the STORE_CosmeticStore root are used for compatability with other
	PERKS_Components and are unused for the Cosmetic Store iteself:
	
	These custom properties are to complement the PERKS_SubscriptionShop:
	PremiumCurrencyName
	SubscriptionName
	SubscriptionOneTimeReward
	SubscriptionOneTimePremiumReward
	
	These custom properties are to complement the PERKS_PremiumCurrencyShop:
	PremiumTier1Amount
	PremiumTier2Amount
	PremiumTier3Amount
