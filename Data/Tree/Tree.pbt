...
Objects {
  ...
  UnregisteredParameters {
    ...
    Overrides {
      ...
      String: "Benefits: <br> - 1.5 Currency Multiplier <br>  (+0.1 for every VIP in the game) <br> - VIP Room Access <br> - VIP Group Access With 2 or more VIPs <br> - VIP Exclusive Outfit"
    }
    Overrides {
